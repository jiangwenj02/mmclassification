...
data = dict(
    train=dict(data_prefix='/data2/zinan_xiong/gastritis_0227_high_resolution_v2/train'),
    ...
    val=dict(data_prefix='/data2/zinan_xiong/gastritis_0227_high_resolution_v2/test'),
    test=dict(data_prefix='/data2/zinan_xiong/gastritis_0227_high_resolution_v2/test')
    )
