...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', nargs='+', type=str, default='configs/diseased/resnet50_diseased3.py', help='model.pt path(s)')
    parser.add_argument('--weights', nargs='+', type=str, default='work_dirs/resnet50_diseased3/latest.pth', help='model.pt path(s)')
