...
python tools/visualizations/vis_cam_config.py configs/diseased/seresnet50_b32x8_stomach_hr.py work_dirs/seresnet50_b32x8_stomach_hr/latest.pth  --target-layers model.backbone.layer4.2  --method GradCAM