...
python tools/visualizations/vis_cam_config.py configs/diseased/shuffle_stomach_hr.py work_dirs/shuffle_stomach_hr/latest.pth  --target-layers model.backbone.layer4.2  --method GradCAM  --method GradCAM --save-path work_dirs/shuffle_stomach_hr/grad_cam200
